...
// Constants for user applying for a job
...
// Constants for loading all users
...
// Constants for user sign-up
export const USER_SIGNUP_REQUEST = "USER_SIGNUP_REQUEST";
export const USER_SIGNUP_SUCCESS = "USER_SIGNUP_SUCCESS";
export const USER_SIGNUP_FAIL = "USER_SIGNUP_FAIL";
export const USER_SIGNUP_RESET = "USER_SIGNUP_RESET";

// Constants for deleting a user
export const DELETE_USER_REQUEST = "DELETE_JOB_REQUEST";
export const DELETE_USER_SUCCESS = "DELETE_JOB_SUCCESS";
export const DELETE_USER_FAIL = "DELETE_JOB_FAIL";
export const DELETE_USER_RESET = "DELETE_JOB_RESET";
